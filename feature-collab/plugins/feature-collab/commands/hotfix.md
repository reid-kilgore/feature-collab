...
2. **Demo (conditional)**: If the hotfix touched API endpoints, launch `api-walkthrough` agent to author a Bruno walkthrough collection capturing the regression scenario and fix verification. For non-API hotfixes, skip the demo phase.
